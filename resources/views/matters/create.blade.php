                ...
                {{csrf_field()}}
                    ...
                    <div class="ml-3 form-group">
                        ...
                        <div class="form-check form-check-inline row">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="Webサイト" name="products[]">
                            <label class="form-check-label" for="inlineCheckbox1">Webサイト</label>
                            </div>
                            <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="LP" name="products[]">
                            <label class="form-check-label" for="inlineCheckbox2">LP</label>
                            </div>
                            <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="メディア" name="products[]">
                            <label class="form-check-label" for="inlineCheckbox3">メディア</label>
                            </div>
                            <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="その他" name="products[]">
                            <label class="form-check-label" for="inlineCheckbox3">その他</label>
                            </div>
                    </div>
                    <div class="form-group">
                        <label for="CommentsFormControlTextarea">備考</label>
                        <textarea class="form-control" name="comments" placeholder="備考を入力してください" rows="3"></textarea>
                    </div>
